...
export const FeaturesSection = () => {
    return (
        <section className="py-20 bg-gradient-to-b from-stone-50 to-white relative overflow-hidden">
            {/* Decorative elements */}
            <div className="absolute top-20 left-10 w-48 h-48 bg-amber-100/30 rounded-full blur-3xl" />
            <div className="absolute bottom-1/3 right-20 w-64 h-64 bg-blue-100/20 rounded-full blur-3xl" />
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                ...
                >
                    ...
                    <div className="w-20 h-1 bg-gradient-to-r from-amber-400 to-yellow-300 mx-auto mb-6" />
                ...
                >
                    {features.map(({ title, icon: Icon, color, iconColor, description, stat, statLabel }, i) => (
                        <motion.div
                            ...
                            whileHover="hover"
                            className="rounded-xl bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden"
                        >
                            <div className="p-6">
                                ...
                                <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                                    <span className="text-2xl font-bold text-gray-900">{stat}</span>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="mt-16 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl p-8 border border-amber-200"
                >
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="bg-gradient-to-r from-amber-500 to-yellow-400 text-white px-8 py-3 rounded-lg font-medium hover:opacity-90 transition duration-300 shadow-md"
                        >
                            Request a Quote
                        </motion.button>
                    </div>
